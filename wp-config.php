...
define('WP_HOME', 'https://' . filter_input(INPUT_ENV, 'FRONT_DOOR_HOST', FILTER_SANITIZE_STRING));
define('WP_SITEURL', 'https://' . filter_input(INPUT_ENV, 'FRONT_DOOR_HOST', FILTER_SANITIZE_STRING));
